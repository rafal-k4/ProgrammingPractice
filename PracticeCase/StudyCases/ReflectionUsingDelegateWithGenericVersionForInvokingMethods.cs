...
{
    /// <summary>
    /// Link to the article explaining what is going on here:
    /// https://codeblog.jonskeet.uk/2008/08/09/making-reflection-fly-and-exploring-delegates/
    /// </summary>
    class ReflectionUsingDelegateWithGenericVersionForInvokingMethods : IStudy
    {
        public void Execute()
        {
        ...
        static Func<T, object, object> MagicMethod<T>(MethodInfo method) where T : class
        {
            ...
            MethodInfo genericHelper = typeof(ReflectionUsingDelegateWithGenericVersionForInvokingMethods).GetMethod("MagicMethodHelper", BindingFlags.Static | BindingFlags.NonPublic);

            // Now supply the type arguments
            MethodInfo constructedHelper = genericHelper.MakeGenericMethod(typeof(T), method.GetParameters()[0].ParameterType, method.ReturnType);
        ...
        static Func<TTarget, object, object> MagicMethodHelper<TTarget, TParam, TReturn>(MethodInfo method) where TTarget : class
        {
